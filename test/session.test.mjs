...
test('queued draft cannot be written into a different account',async()=>{
 let calls=0;const context=vm.createContext({document:{addEventListener(){}},clearTimeout,setTimeout,fetch:async()=>{calls++;return {ok:true,json:async()=>({})}},go:()=>{}});
 vm.runInContext(source,context);
